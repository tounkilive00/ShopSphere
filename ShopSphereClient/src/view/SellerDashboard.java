    ...
    private void loadData() {
        SwingWorker<Void, Void> w = new SwingWorker<Void, Void>() {
            ...
            @Override protected Void doInBackground() throws Exception {
                ...
                OrderService   os = RMIClient.getOrderService();
                products = ps.findProductRecordsBySeller(currentUser.getId());
                orders   = os.findOrderRecordsByBuyer(currentUser.getId()); // simplifie
                revenue  = os.calculerRevenuVendeur(currentUser.getId());
                return null;
            }
