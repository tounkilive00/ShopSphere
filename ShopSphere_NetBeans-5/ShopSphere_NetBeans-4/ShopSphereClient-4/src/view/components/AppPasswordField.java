 ...
 * Champ mot de passe personnalise avec bouton afficher/masquer propre.
 */
 ...
 * Compatible avec tous les OS sans caracteres casses.
 * @author ShopSphere
 */
public class AppPasswordField extends JPanel {
    ...
    public AppPasswordField(String placeholder) {
        ...
        // Placeholder simulation & border active states
        ...
        // Toggle afficher / masquer avec du texte clair sans icônes cassées
        toggleBtn = new JToggleButton("Voir");
        toggleBtn.setFont(new Font("SansSerif", Font.BOLD, 11));
        toggleBtn.setForeground(Theme.PRIMARY);
        toggleBtn.setBackground(Theme.BG_INPUT);
        toggleBtn.setBorder(new EmptyBorder(0, 8, 0, 12));
        ...
        toggleBtn.addActionListener(e -> {
            if (toggleBtn.isSelected()) {
                ...
                toggleBtn.setText("Masquer");
                toggleBtn.setForeground(Theme.ACCENT);
            } else {
                passwordField.setEchoChar('•'); // masquer
                toggleBtn.setText("Voir");
                toggleBtn.setForeground(Theme.PRIMARY);
            }
        });
