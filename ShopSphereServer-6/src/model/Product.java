...
public class Product implements Serializable {
    ...
    // Visibilite catalogue — distincte du statut : un produit ACTIF peut etre
    // masque temporairement (reversible) par le vendeur ou l'admin sans etre archive/supprime.
    ...
    public String toString() {
        return title + " (" + category + ") - " + getPricePerUnit() + " FCFA";
    }
}
