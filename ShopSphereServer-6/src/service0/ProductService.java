...
public interface ProductService extends Remote {
    ...
    Product hardDeleteProductRecord(Product productObj)   throws RemoteException; // suppression definitive (Admin)
    ...
    Product setProductVisibility(int productId, boolean visible) throws RemoteException;
